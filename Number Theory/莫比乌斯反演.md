...
<img src="https://github.com/KingJoySaiy/R.O.D./tree/master/Number%20Theory/_image/mobius_1.png" width="150" height="150" />
```c++
const int maxn = 1e6;
bool check[maxn+5];
...
<img src="https://github.com/KingJoySaiy/R.O.D./tree/master/Number%20Theory/_image/mobius_2.png" width="150" height="150" />

从上面表格里面发现规律，得出g(x)的表达式  ~~（这是显然的，不清楚可以自行脑补)~~：`g(x) = ∑_(d|x) f(d)*μ(x/d)`。通过换元法，另`t=x/d`，则`t|x，x/t=d，x/d=t`，最终得到如下公式：
<img src="https://github.com/KingJoySaiy/R.O.D./tree/master/Number%20Theory/_image/mobius_3.png" width="150" height="150" />
## 三、欧拉筛法
